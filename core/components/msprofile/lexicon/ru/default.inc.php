...
$_lang['msprofile_intro_msg'] = 'Обратите внимание, что профиль покупателя создаётся при первой операции оплаты или пополнение счета. Если пользователь только зарегистрировался и еще ничего не сделал, его профиля здесь не будет.';
