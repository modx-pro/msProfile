...
$sources = array(
	...
	'source_ms2_core' => $root.'core/components/minishop2/custom/payment/customeraccount.class.php',
);
unset($root);
...
$vehicle->resolve('file',array(
	'source' => $sources['source_ms2_core'],
	'target' => "return MODX_CORE_PATH . 'components/minishop2/custom/payment/';",
));
